'''
ZFJ 2022
Originated From: huggingface/transformers/trainer.py
modified it to use top_p sampling
'''
import torch
...
class MySeq2SeqTrainer(Seq2SeqTrainer):
    def predict(
        ...
        self._max_length = max_length if max_length is not None else None
    ...
    def evaluation_loop(
        ...
        if all_preds is not None:
            all_preds = nested_truncate(all_preds, num_samples) if not self._do_sample else nested_truncate(all_preds, num_samples*self._num_return_sequences)
